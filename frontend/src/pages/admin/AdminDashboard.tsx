...
const AdminDashboard: React.FC = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-blue-600">LegalKonect Admin</h1>
      ...
      <div className="flex">
        {/* Sidebar Navigation */}
        <aside className="w-64 bg-white shadow-sm h-[calc(100vh-4rem)] border-r border-gray-200 fixed top-16 left-0 overflow-hidden">
