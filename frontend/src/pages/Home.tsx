          ...
          <div className="flex justify-between items-center h-16 lg:h-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium transition-colors"
              >
                Find Lawyers
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <button
                onClick={() => navigate('/lawyers')}
                className="group px-8 py-4 bg-blue-600 text-white rounded-md font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
              >
                Browse Lawyers
              ...
              <button
                ...
                className="px-8 py-4 bg-white text-blue-600 border-2 border-blue-600 rounded-md font-semibold hover:bg-blue-50 transition-colors"
              >
                Join as Lawyer
              </button>
            </div>
