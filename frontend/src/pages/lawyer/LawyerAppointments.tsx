        ...
        <div className="bg-white rounded-2xl border-2 border-gray-100 p-2 mb-6">
          <nav className="flex gap-2 overflow-x-auto">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-medium text-sm whitespace-nowrap transition-all ${
                activeTab === 'new' ? 'bg-blue-600 text-white shadow-lg shadow-blue-200/50' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              <Sparkles className="w-4 h-4" />
              New Booking
              <span className={`py-0.5 px-2 rounded-full text-xs ${
                activeTab === 'new' ? 'bg-white/20' : newBookingCount > 0 ? 'bg-blue-100 text-blue-700' : 'bg-gray-100'
              }`}>
                {newBookingCount}
              </span>
            </button>
                ...
                <div className="w-full lg:w-auto lg:ml-6 flex flex-col lg:items-end space-y-3 border-t lg:border-t-0 pt-4 lg:pt-0 lg:flex-shrink-0 lg:min-w-[200px]">
                  ...
                  <div className="flex flex-col gap-3 w-full">
                    ...
                    {appointment.status === 'cancelled' && appointment.refund_receipt && (
                      <div className="w-full px-4 py-2.5 rounded-xl text-xs font-semibold bg-green-50 text-green-700 border border-green-200 flex items-center justify-center gap-2">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
