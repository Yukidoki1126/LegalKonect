          ...
          <div className="mb-8 bg-green-50 border-l-4 border-green-500 text-green-700 px-6 py-4 rounded-r-lg shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {syncMessage && <p className="text-sm mt-1">{syncMessage}</p>}
              </div>
            </div>
          </div>
        )}
              ...
              {status?.connected ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-red-600 text-white rounded-lg text-sm font-semibold hover:bg-red-700 disabled:bg-gray-400 transition-colors"
